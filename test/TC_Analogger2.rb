...
class TC_Analogger2 < Test::Unit::TestCase
	...
	def test_analogger
		@analogger_pid = SwiftcoreTestSupport::create_process(:dir => '.',:cmd => ["#{@rubybin} -I /opt/workspace/analogger/src ../bin/analogger -c analogger.cnf"])
		sleep 1
		logger = nil
